...
function Window:Notify(Text, Options)
    ...
    local Frame = Util.Frame(self.NotificationLayer, `Notification_{#self.Notifications + 1}`, UDim2FromOffset(Width + 14, 0), UDim2FromOffset(Width, Height), Theme.Outer, 650);
    ...
    function Notification:Close()
        ...
        Util.Tween(Frame, {
            Position = UDim2FromOffset(Width + 14, self.TargetY or 0),
    ...
    Frame.Position = UDim2FromOffset(Width + 14, Notification.TargetY);
    Util.Tween(Frame, { Position = UDim2FromOffset(0, Notification.TargetY) }, 0.22);
