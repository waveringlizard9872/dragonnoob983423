...
function Window:AddTab(Name)
    local TabFrame    = Util.Frame(self.TabBar, `Tab_{Util.CleanName(Name)}`, UDim2FromOffset(1, 1), UDim2FromOffset(1, Layout.TabInnerHeight), Theme.Tab, 107);
    local TabInner    = Util.Frame(TabFrame, "Inner", UDim2FromOffset(1, 1), UDim2.new(1, -2, 1, -2), Theme.TabGradientTop, 108);
    local TabGradient = Util.Gradient(TabInner, Theme.TabGradientTop, Theme.TabGradientBottom);
