...
function Groupbox:AddSubTabs(Names, ActiveIndex, Position, Size, Callback)
    ...
    for Index, Name in ipairs(Names) do
        ...
        local ItemFrame = Util.Frame(Holder, `SubTab_{Util.CleanName(Name)}`,
            ...
            Theme.Tab, 117);
        local ItemInner    = Util.Frame(ItemFrame, "Inner", UDim2FromOffset(1, 1), UDim2.new(1, -2, 1, -2), Theme.TabGradientTop, 118);
        local ItemGradient = Util.Gradient(ItemInner, Theme.TabGradientTop, Theme.TabGradientBottom);
