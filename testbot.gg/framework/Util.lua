...
local Util = { }; do
    ...
    function Util.MakeControl(Parent, Name, Position, Size, ZIndex)
        local Control = Util.Frame(Parent, Name, Position, Size, Theme.ControlTop, ZIndex or 120);
        Util.Stroke(Control, Color3FromRGB(24, 23, 29), 1);
        Util.Gradient(Control, Theme.ControlTop, Theme.ControlBottom);
        return Control;
    end
